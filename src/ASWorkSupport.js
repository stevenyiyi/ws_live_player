...
import ASLoader from "./ASLoaderWorker.js";
// Re-export ASLoader so the base URL can be inserted
// when using CDN compatibility blob loading.
global.ASLoader = ASLoader;
/**
 * Web Worker wrapper for codec fun
 */
class ASWorkerSupport {
  constructor(propList, handlers) {
    ...
    this.handlers.construct = (args, callback) => {
      ...
      ASLoader.loadClass(className, (classObj) => {
...
export default ASWorkerSupport;
