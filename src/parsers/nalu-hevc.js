...
export class HEVC_NALU {
    ...
    static get SLICE_TRAIL_N() {return 0;}
    static get SLICE_TRAIL_R() {return 1;}
    static get SLICE_TSA_N() {return 2;}
    static get SLICE_TLA_R() {return 3;}
    static get SLICE_STSA_N() {return 4};
    static get SLICE_STSA_R() {return 5};
    static get SLICE_RADL_N() {return 6};
    static get SLICE_RADL_R() {return 7};
    static get SLICE_RASL_N() {return 8};
    static get SLICE_RASL_R() {return 9;}
    static get SLICE_BLA_W_LP() {return 16;}
    static get SLICE_BLA_W_RADL() {return 17;}
    static get SLICE_BLA_N_LP() {return 18;}
    static get SLICE_IDR_W_RADL() {return 19;}
    static get SLICE_IDR_N_LP() {return 20;}
    static get SLICE_CRA() {return 21;}
    static get SLICE_RSV_IRAP_VCL22() {return 22;}
    static get SLICE_RSV_IRAP_VCL23() {return 23;}
    static get VPS() {return 32;}
    static get SPS() {return 33;}
    static get PPS() {return 34;}
    static get DELIMITER() {return 35;}
    static get EOS() {return 36;}
    static get EOB() {return 37;}
    static get FILTER() {return 38;}
    static get PREFIX_SEI() {return 39;}
    static get SUFFIX_SEI() {return 40;}
    static get STAP() {return 48;}
    static get FU() {return 49;}
    static get PACI() {return 50;}
    ...
    */
    ...
    toString() {
        return `${HEVC_NALU.type(this)}(${this.data.byteLength}): LayerID: ${this.getLayerID()}, TID: ${this.getTID()}, PTS: ${this.pts}, DTS: ${this.dts}`;
    }
